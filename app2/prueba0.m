...
%% vamos a leer un video
video_dir = '/home/osvaldo13576/Documents/pupil_data/2022_10_14/002/exports/005/world.mp4';
heat_dir = '/home/osvaldo13576/Documents/pupil_data/2022_10_14/002/exports/005/surfaces/heatmap_Surface 1.png';
video = VideoReader(video_dir);
lec=read(video,1);
heat = imread(heat_dir);
fu=imfuse(lec,heat);
imshow(fu)
